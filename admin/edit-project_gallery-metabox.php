 ...
 * 
 */
function project_gallery_add_metabox(){
	add_meta_box(
		'post_custom_gallery',
		'Project Gallery',
		'project_gallery_metabox_callback',
		'project', // Change post type name
		'normal',
		'core'
	);
}
add_action( 'admin_init', 'project_gallery_add_metabox' );

function project_gallery_metabox_callback(){
...
function project_gallery_styles_scripts(){
    global $post;
...
add_action( 'admin_head-post.php', 'project_gallery_styles_scripts' );
add_action( 'admin_head-post-new.php', 'project_gallery_styles_scripts' );

function project_gallery_save( $post_id ) {
	...
	if (! isset($_POST['post_type'])) { // if post is new and post_type is not set
		...
		if ( 'project' != $_POST['post_type'] ) // here you can set the post type name
			return;
...
add_action( 'save_post', 'project_gallery_save' );
?>